...
public class ModelViewControllerIT extends AssertJSwingJUnitTestCase {
    ...
    protected void onSetUp() {
        ...
        window = new FrameFixture(
                ...
                GuiActionRunner.execute(() -> {
                    BookingSwingView bookingSwingView =
                    ...
                    bookingSwingView.setBookingController(
                            bookingController
                    );
    ...
    public void testAddBooking() {
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS)
                .untilAsserted(() ->
                        assertThat(bookingRepository.findById("TBL-001"))
                                .isEqualTo(
                                        new Booking(
                                                "TBL-001",
                                                "Marco Rossi",
    ...
    public void testUpdateBooking() {
        ...
        Awaitility.await().atMost(5, TimeUnit.SECONDS)
                .untilAsserted(() ->
                        assertThat(bookingRepository.findById("TBL-003"))
                                .isEqualTo(
                                        new Booking(
                                                "TBL-003",
                                                "Luca Ferrari",
